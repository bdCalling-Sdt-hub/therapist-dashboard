...
import MatchedTherapistListTable from "./MatchedTherapistListTable";

function MatchedTherapistList() {
    ...
    <div className="mt-5">
      <div className="bg-white h-[70vh] rounded-xl overflow-hidden">
        <div className="flex justify-between py-[20px] p-[20px] bg-primary">
          <h1 className="text-[32px] text-white">Matched Therapist</h1>
...
export default MatchedTherapistList;
